          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "2px 10px 12px" }}>
            {requests.length === 0 ? (
              ...
              requests.map(r => {
                ...
                const userType = r.user.userType;
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 2 }}>
                      ...
                      <span style={{ fontSize: 9, background: active ? "#1d3461" : "#f1f5f9", color: active ? "white" : "#64748b", padding: "2px 7px", borderRadius: 4, fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em", flexShrink: 0 }}>
                        {userType}
                      </span>
                    </div>
                    {/* Row 2: Entity · RLDC */}
                    <p style={{ margin: "0 0 5px", fontSize: 11.5, fontWeight: 500, color: "#334155", lineHeight: 1.3 }}>
                      {entityLine || r.user.profile?.fullName || r.user.username}
                    </p>
                    {/* Row 3: Verification status pills */}
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <span style={{ fontSize: 10, color: "#16a34a", fontWeight: 500 }}>✓ Details verified</span>
                      <span style={{ fontSize: 10, color: "#d97706", fontWeight: 500 }}>◦ Location IDs pending</span>
                    </div>
                  </button>
                );
              })
            ...
            {!selectedId ? (
              ...
              <div style={{ background: "white", borderRadius: 10, border: "1px solid #e2e8f0", overflow: "hidden" }}>
                ...
                <div style={{ padding: "14px 20px", borderBottom: "1px solid #e2e8f0" }}>
                  <h2 style={{ margin: 0, fontSize: 15, fontWeight: 700, color: "#0f172a" }}>
                    {displayReqId} — {u.entity?.entityName ?? u.profile?.fullName ?? u.username}
                  </h2>
                </div>
